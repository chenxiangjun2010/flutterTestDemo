...
const Color kPickerBgColor = Colors.white;
const Color kPickerBgDarkColor = Color(0xFF1E1E1E); // (30, 30, 30)
const Color kPickerTitleColor = Color(0xFF787878); // (120, 120, 120)
const Color kPickerTitleDarkColor = Color(0xFF878787); // (135, 135, 135)
const Color kPickerTextColor = Color(0xFF333333);
const Color kPickerTextDarkColor = Color(0xFFC6C6C6);
const Color kPickerRedTextDarkColor = Color(0xFFE64242); // (230, 66, 66)
const Color kPickerHeaderColor = kPickerBgColor;
const Color kPickerHeaderDarkColor = kPickerBgDarkColor;
const Color kPickerHeaderLineColor = Color(0xFFE6E6E6);
const Color kPickerHeaderLineDarkColor = Color(0xFFC6C6C6); // (198, 198, 198)
const Color kPickerBtnColor = Color(0xFF232323); // (35, 35, 35)
const Color kPickerBtnDarkColor = Color(0xFFC6C6C6); // (198, 198, 198)
...
class BasePickerViewState extends State<BasePickerView> {
  ...
  _body() {
    var bgColor = kPickerBgColor;
    var headerColor = kPickerHeaderColor;
    var headerLineColor = kPickerHeaderLineColor;
    var titleColor = kPickerTitleColor;
    var btnColor = kPickerBtnColor;
    var selectTextColor = kPickerTextColor;
